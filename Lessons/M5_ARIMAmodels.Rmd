...
#tailing data to make sure there werent any missing data
```
## ACF and PACF plots
...
#some of the wave patterns are now removed but trend is still there. 
...
#Run ADF
adf.test(deseasonal_residential_price, alternative = "stationary")
...
#want the biggest negatice AIC
#but look at coefficients (212 is all close to 1 - we dont want them to be close to 1 or -1)
#want stable model and interpretable coefficients
```
