...
SMA_deseas <- sma(y= deseasonal_allsectors_price, h=36, silent=T, holdout=F)
summary(SMA_deseas$forecast)


# Model 6: Simple moving average on original data
SMA_seas <- sma(y=ts_electricity_price[,"All.sectors"],h=36, silent =T, holdout=F)
summary(SMA_seas$forecast)
